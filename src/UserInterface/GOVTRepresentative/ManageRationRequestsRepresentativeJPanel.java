 ...
 * @author rtspi
 */
public class ManageRationRequestsRepresentativeJPanel extends javax.swing.JPanel {
    ...
    public ManageRationRequestsRepresentativeJPanel(JPanel userProcessContainer, Enterprise enterprise,UserAccount account,OrganizationDirectory orgDir,Organization organization) {
        initComponents();
        ...
        DefaultTableModel model = (DefaultTableModel) tblRequestHistory.getModel();
         model.setRowCount(0);
           ...
           for(RationRequest req : representative.getRationRequestDirectory().getRationRequestList()){
        ...
        layout.setVerticalGroup(
            ...
            .addGroup(layout.createSequentialGroup()
                ...
                .addGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING)
                    ...
                    .addComponent(btnReject))
                .addGap(73, 73, 73)
                .addComponent(btnComplete, javax.swing.GroupLayout.PREFERRED_SIZE, 48, javax.swing.GroupLayout.PREFERRED_SIZE)
